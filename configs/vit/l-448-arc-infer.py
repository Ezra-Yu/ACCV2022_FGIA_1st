...
custom_imports = dict(imports=['mmselfsup.engine', 'mmselfsup.models'], allow_failed_imports=False)
...
launcher = 'slurm'
work_dir = './work_dirs/vit-large-p16_ft-8xb128-coslr-arcface-50e_in1k-448'
