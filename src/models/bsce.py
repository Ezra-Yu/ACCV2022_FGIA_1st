...
class BalancedSoftmax(_Loss):
    ...
    def forward(self, input, label, eight=None, avg_factor='mean', reduction_override=None, **kwargs):
        return balanced_softmax_loss(label, input, self.sample_per_class, avg_factor)
